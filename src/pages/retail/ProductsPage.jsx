  ...
  return (
    <div className="flex-1 overflow-y-auto relative">
      ...
      <div className="absolute top-0 left-[-9999px] opacity-0 pointer-events-none">
        <div id="print-barcodes-container" className="bg-white p-6" style={{ width: '210mm', minHeight: '297mm' }}>
          <div className="grid grid-cols-4 gap-4">
            {products.filter(p => selectedProducts.includes(p.id) && p.barcode).map(p => (
